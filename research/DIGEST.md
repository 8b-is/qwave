...
> **Corrections since this digest was written (v0.3.0, 2026-08-13):**
> SafariConverterLib is **AdGuard's project, GPL-3.0** — not a WebKit
> component and not LGPL as stated below; the license gate **passed** for
> strict build-time use and the compiled EasyList snapshot shipped in
> v0.3.0 (see [docs/BLOCKLIST.md](../docs/BLOCKLIST.md) and the corrected
> [research/adblocking/safariconverterlib.md](adblocking/safariconverterlib.md)).
> WebURL's repo is `karwa/swift-url` (adopted in v0.3.0 as `URLIdentity`);
> swift-snapshot-testing's latest 1.x is 1.19.4. Findings 1, 2, 4 and 5
> below all landed in v0.3.0.
